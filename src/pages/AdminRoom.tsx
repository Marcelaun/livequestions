                    ...
                    return (
                        ...
                        >
                            {!admquestion.isAnswered && (
                              ...
                              <button
                                type="button"
                                onClick={() => handleCheckQuestionAsAnswered(admquestion.id)}
                                >
                                ...
                                >
                                    <img src={answerImg} title="Dar destaque a pergunta" alt="Dar destaque à pergunta" />
                                </button>
                                </>
                            )}
                            ...
                            >
                                <img src={deleteImg} title="Remover a pergunta" alt="Remover pergunta" />
                            </button>
                        </AdminQuestion>
                    );
                })}
